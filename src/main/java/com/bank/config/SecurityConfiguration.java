...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(request -> request.requestMatchers("/api/v1/auth/**","/api/v1/transactions/**","/api/v1/accounts/**","/api/v1/payments/**","/api/v1/users/**").permitAll()//,"/api/v1/transactions/**").permitAll()
